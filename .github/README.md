...
[`@aws-sdk/client-wisdom`](https://www.npmjs.com/package/@aws-sdk/client-wisdom/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wisdom@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dKHClwIBx6VZiUWUs6sAP3HOwCBiQIXhLBuhlKC7w/zswDyN8MzqSJr613GChTDL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-wisdom": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wisdom@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wisdom@3.128.0/index.min.mjs": "sha384-dKHClwIBx6VZiUWUs6sAP3HOwCBiQIXhLBuhlKC7w/zswDyN8MzqSJr613GChTDL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-wisdom/blob/refs/tags/3.128.0/LICENSE
```
